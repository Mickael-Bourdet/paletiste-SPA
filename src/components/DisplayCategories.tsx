...
export default function DisplayCategories() {
  return (
    <div className="wrapper py-10">
      <h2 className="text-3xl mb-4 font-title md:text-left md:pl-6 mdl:pl-14 xlg:pl-10 2xl:pl-0">
          ...
          <Link to="/categories/fonte">
            <div className="h-50 relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center flex-col gap-10">
                <p className="text-body font-extrabold text-3xl text-center drop-shadow-lg px-2">
                  {" "}
                  Fonte
                </p>
                <p className="text-body font-extrabold text-xl text-center drop-shadow-lg px-2">
                  {" "}
                  406 concours
                </p>
              </div>
